...
export default function App() {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      else if (hash === '#/arch') setCurrentPage('arch');
      else setCurrentPage('generate');
    };
    handleHashChange();
  ...
  const showGenerate = currentPage === 'generate';
  const showStudio = currentPage === 'studio';
  const showArch = currentPage === 'arch';

  return (
    <>
      {showGenerate && <DotGrid isMorphing={state.phase === 'loading'} />}
      {showGenerate && (
        <SceneRoot>
          <SingleCloudLayout
            phase={state.phase}
